...
class DomainManager:
    ...
    def _load_domains(self):
        ...
        # 获取领域配置目录
        domain_dir = config.get('domains', {}).get('config_dir', 'domains')
    ...
    def register_domain(self, domain: str, config: Dict[str, Any], save: bool = True) -> None:
        ...
        if save:
            from src.config.env_manager import init_config
            system_config = init_config()
            domain_dir = system_config.get('domains', {}).get('config_dir', 'domains')
